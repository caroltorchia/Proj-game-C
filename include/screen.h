...
#define HANGMAN_HEAD   "(O)"
#define HANGMAN_BODY   "|"
#define HANGMAN_LEFT_ARM "/  \\"
#define HANGMAN_RIGHT_ARM "\\  /"
#define HANGMAN_LEFT_LEG  "| /"
#define HANGMAN_RIGHT_LEG "|\\"
...
* @param remaining_time time remaining to complete word
*/
void displayTimeRemaining(int remaining_time);

void drawHangedMan(int wrongAttempts);
